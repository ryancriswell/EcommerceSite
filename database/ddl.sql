...
Create Table OrderItem (
  ...
  foreign key (order_id) references UserOrder
    on delete cascade
    on update cascade,
...
Create Table LogEntry {
  ...
  username varchar(16), -- relavent user, if any [ref: > User.username]
  order_id int, -- relavent order, if any [ref: > Order.order_id]
  item_id int, -- relavent item, if any [ref: > Item.item_id]
